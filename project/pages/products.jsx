...
function ProductsPage({ accent, go }) {
  return (
...
function ProductPage({ slug, accent, go }) {
  ...
  return (
    <div className="wa-page" style={{ height: '100%', overflow: 'auto' }}>
      ...
      <section style={{ position: 'relative', padding: '60px 40px 40px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 48, alignItems: 'start' }}>
          <div>
      ...
      <section style={{ padding: '40px 40px' }}>
        ...
        <h2 style={{ margin: 0, fontSize: 48, fontWeight: 700, letterSpacing: -1.6 }}>
      ...
      {related.length > 0 && (
        <section style={{ padding: '60px 40px' }}>
          ...
          <h2 style={{ margin: '0 0 24px', fontSize: 36, fontWeight: 700, letterSpacing: -1 }}>
...
Object.assign(window, { ProductsPage, ProductPage });
