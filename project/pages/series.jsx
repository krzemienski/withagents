...
function PostPage({ slug, accent, go }) {
...
// =============================================================================
// PostPager — top-of-article navigator. Shows prev / current / next so switching
// posts is unambiguous and grounded ("you are HERE, prev is X, next is Y").
// Replaces the old reliance on the rail alone.
// =============================================================================
...
Object.assign(window, { SeriesPage, PostPage, BodyBlock, PostPager });
