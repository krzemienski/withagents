...
const HERO_SCENES = ['stream', 'swarm', 'pipeline', 'diff'];
const SCENE_DURATION_MS = 9000;
const FADE_MS = 1100;

function HeroSceneCanvas({ accent, scrollY = 0, sceneOverride = null }) {
...
Object.assign(window, { HeroSceneCanvas, HERO_SCENES });
