// components/interactive-diagram.jsx
//
...
//
// This is the "interactive diagram" the user asked for — not just a static
// chart, an actual stateful artefact that teaches the consensus-gate concept.
...
function InteractiveConsensusGate({ accent }) {
...
Object.assign(window, { InteractiveConsensusGate });
