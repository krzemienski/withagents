...
subtitle: >-
  When to call the API directly, when to use Claude Code CLI, and when you
  need both — a practical guide from the series finale
...
reading_order: '14'
arc_position: '6D-closer-decision-framework'
seoTitle: "SDK vs CLI: The Decision Framework That Took 23,479"
slug: 'post-18-sdk-vs-cli'
status: 'scheduled'
publishedAt: null
scheduledFor: "2026-06-11T00:00:00Z"
updatedAt: '2026-04-23'
category: 'Agentic Development'
canonicalUrl: "https://withagents.dev/posts/post-18-sdk-vs-cli"
heroImage: null
ogImage: null
twitterImage: null
linkedinImage: null
...
Last post. Nineteen entries, 23,479 sessions, 11.6 GB of session data across 27 projects over 42 days. And the question I get asked more than any other is this: should I use the Anthropic SDK, the Claude Code CLI, or the Agent SDK?
...
*The series-finale post in "Agentic Development: 19 Lessons from 23,479 Sessions" series. The [claude-code-monorepo](https://github.com/krzemienski/claude-code-monorepo) contains all the patterns side by side: `basic-agent.ts` and `multi-agent-pipeline.ts` for the SDK approach, `hat-rotation.sh` and `worktree-parallel.sh` for the CLI approach, and `decision-matrix.ts` for the scoring framework. Every claim in this series traces to a real session. Every system has a companion repo you can run yourself. The sessions generated 11.6 GB of data across 42 days. The frameworks emerged from the failures. The only original insight? The tools are ready. The decision is knowing which one to pick.*
