...
reading_order: '3'
arc_position: '2A-discipline-rule'
seoTitle: 'I Banned Unit Tests and Shipped Faster'
slug: 'post-03-functional-validation'
status: 'scheduled'
publishedAt: null
scheduledFor: "2026-05-05T00:00:00Z"
updatedAt: '2026-04-24'
category: 'Agentic Development'
canonicalUrl: "https://withagents.dev/posts/post-03-functional-validation"
heroImage: null
ogImage: null
twitterImage: null
linkedinImage: null
...
This is Post 3 of "Agentic Development: 19 Lessons from 23,479 AI Coding Sessions." The companion repo is [claude-code-skills-factory](https://github.com/krzemienski/claude-code-skills-factory).
...
So I built a hook. `block-test-files` runs on every Write and Edit. If the path matches any of 13 regex patterns — test directories, test/spec/mock extensions, case-insensitive mock/stub/fake/fixture prefixes — the operation gets blocked:
