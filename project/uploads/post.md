...
subtitle: >-
  What 11.6GB of session data across 27 projects reveals about building
...
Every system in the next eighteen posts exists because something broke. These five failure modes showed up in the first week and never stopped.
...
## What the Next Eighteen Posts Cover
...
**Post 19: Anneal — Three Planning Variants.** 60% of session failures traced back to the plan, not the executor. Three Claude Code plugins (Cast, Alloy, Temper) that run every plan through a red-team gate before it reaches an agent. The Temper run that planned its own productization — 17 minutes 36 seconds, score 98, verdict SAFE.
...
flowchart LR
    ...
    M4 --> CONS
    M5 --> CONS
    CONS --> POSTS["19 Posts<br/>Every claim<br/>traceable"]
...
Read all nineteen posts and you'll have:
