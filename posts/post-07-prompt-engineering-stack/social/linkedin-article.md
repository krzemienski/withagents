...
If your AI agents "understand" your rules but break them under pressure, you don't have a prompt problem — you have a system problem. Here's the 7-layer enforcement stack that dropped aggregate violation rates 87% across 23,479 sessions, borrowing from Shannon's information theory: redundant encoding produces reliable transmission.
...
> **Diagram: The 7-Layer Prompt Engineering Stack**
> - Layer 1: CLAUDE.md Constitution — global + project instructions
> - Layer 2: Rules Directory — `.claude/rules/*.md` focused rule files
> - Layer 3: Hooks — PreToolUse blocks, PostToolUse reminders
> - Layer 4: Skills — structured workflows with gates
> - Layer 5: Agents — specialized roles with scoped instructions
> - Layer 6: MCP Tools — external capabilities + constraints
> - Layer 7: Session Start Hooks — inject context from turn 1
...
> **Diagram: Hook Decision Flow**
> - Agent requests tool call → PreToolUse hooks run first
> - Block decision: tool call prevented, decision returned to agent
> - Warn decision: tool proceeds, warning injected into context
> - Allow decision: tool proceeds cleanly
> - After tool execution, PostToolUse hooks can inject reminders
> - Enriched context returns to the agent for the next turn
...
> **Diagram: CLAUDE.md Inheritance Chain**
> - `~/.claude/CLAUDE.md` (Global Constitution) — no test files, functional validation, evidence-based completion — inherited by all projects
> - `./CLAUDE.md` (Project Constitution) — build commands, tech stack, known pitfalls
> - `.claude/rules/*.md` — nine focused files: security, coding-style, testing, git-workflow, agents, hooks, patterns, performance, development-workflow
> - Each layer extends (not overrides) the one above
...
*Originally published at: https://site-rho-pied.vercel.app/posts/post-07-prompt-engineering-stack*
