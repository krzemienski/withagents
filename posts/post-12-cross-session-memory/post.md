...
subtitle: "A SQLite observation store and MCP memory server that turns 23,479 sessions of amnesia into searchable institutional knowledge"
...
graph TD
    ...
    style SEARCH fill:#1e293b,color:#22d3ee
    style TL fill:#1e293b,color:#22d3ee
    style GET fill:#1e293b,color:#22d3ee
    style NS fill:#0f172a,color:#f1f5f9
```
