...
subtitle: "Token-by-token Claude streaming on iOS — after four failed architectures"
...
graph TB
    ...
    style B fill:#1e293b,stroke:#6366f1,color:#f1f5f9
    style C fill:#1e293b,stroke:#22d3ee,color:#f1f5f9
    style D fill:#1e293b,stroke:#22d3ee,color:#f1f5f9
    style E fill:#1e293b,stroke:#6366f1,color:#f1f5f9
    style F fill:#0f172a,stroke:#6366f1,color:#f1f5f9
```
