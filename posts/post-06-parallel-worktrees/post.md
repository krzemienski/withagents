...
subtitle: "Git worktrees give each AI agent its own filesystem — a five-stage pipeline makes sure they all come back together"
...
flowchart TD
    ...
    style Wave1 fill:#1e293b,stroke:#6366f1,color:#f1f5f9
    style Wave2 fill:#1e293b,stroke:#6366f1,color:#f1f5f9
    style Wave3 fill:#1e293b,stroke:#6366f1,color:#f1f5f9
    style Wave4 fill:#1e293b,stroke:#6366f1,color:#f1f5f9
```
