...
export function WAMark({ size = 28, accent = '#FF3D52' }) {
...
export function WANav({ accent, route, go, compact = false }) {
...
export function WAFooter({ accent, go }) {
  return (
    <footer style={{
...
export function WAEyebrow({ accent, num, label }) {
  return (
...
export function WAStatusPill({ accent, children }) {
  return (
    <div style={{
      ...
      fontSize: 10.5, color: 'rgba(244,243,238,0.75)', letterSpacing: 1.6, lineHeight: 1.4,
...
export function ParallaxAurora({ accent, scrollY = 0 }) {
  return (
...
export function PostGlyph({ kind, size = 22, color = 'rgba(244,243,238,0.75)' }) {
  const s = size;
